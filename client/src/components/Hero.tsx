          ...
          <div className="max-w-6xl mx-auto px-4 min-h-screen max-md:w-screen max-md:overflow-hidden pt-32 md:pt-26 flex items-center justify-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
              <div className="text-left">
                ...
                >
                  Upload product + model. Get ad-ready visuals in seconds. Turn
                  raw photos into commercial-grade lifestyle ads. From images to
                  Reels-ready videos, instantly. No studio. No crew. Just
                  AI-made ads. Drop photos. Download ads. Create brand shoots
